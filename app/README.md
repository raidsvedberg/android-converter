...
This project is a modern Android application designed to convert measurements between the U.S. Customary System and the Metric System. The app supports a wide range of categories including length, area, weight, volume, and temperature. It was built with a focus on usability, accuracy, clean design, and real-time interaction, providing users with an intuitive and comfotable experience.

---
![Smoke Tests](https://github.com/raidsvedberg/android-converter/actions/workflows/android-ui-tests.yml/badge.svg?job=smoke-tests)
![Functional Tests](https://github.com/raidsvedberg/android-converter/actions/workflows/android-ui-tests.yml/badge.svg?job=functional-tests)
![Edge Tests](https://github.com/raidsvedberg/android-converter/actions/workflows/android-ui-tests.yml/badge.svg?job=edge-tests)
